...
#ifndef Q_OS_MAC
    QApplication::setWindowIcon(QIcon(":icons/unbrokencoin"));
    setWindowIcon(QIcon(":icons/unbrokencoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Transfer UBN to another Wallet"));
    ...
    aboutAction = new QAction(QIcon(":/icons/unbrokencoin"), tr("&About Unbrokencoin"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/unbrokencoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/unbrokencoin_testnet"));
            setWindowIcon(QIcon(":icons/unbrokencoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/unbrokencoin_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        ...
        "Do you want to pay the fee?").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::UBN, nFeeRequired));
